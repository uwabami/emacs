...
* 編集/表示関連
  ...
  - [[http://d.hatena.ne.jp/kiwanami/20110221/1298293727][id-manager]] で管理しているパスワードを X CLIPBOARD へ
  #+BEGIN_SRC emacs-lisp
    ...
    (cond
     ...
     ((and (executable-find "xsel")
           (file-exists-p (concat user-emacs-directory ".xsel-use")))
