...
(leaf ido-vertical-mode
  ...
  `(;; 補完候補数の表示
    ...
    (ido-vertical-indicator
     . ,(format "%s" (all-the-icons-faicon "hand-o-right"))))
  :config
  (ido-vertical-mode 1)
  )
   #+end_src
...
** =ido-completing-read=
   :PROPERTIES:
   :CUSTOM_ID: orgd3e51409
   :END:
   惰性で入れてるが, イマイチ使いこなせてない.
   #+BEGIN_SRC emacs-lisp
(leaf ido-completing-read+ :ensure t)
   #+END_SRC
** =ido-describe-bindings=
   :PROPERTIES:
   :CUSTOM_ID: org7bdacc7a
   :END:
   こちらも惰性で入れてるが, イマイチ使いこなせてない.
   #+BEGIN_SRC emacs-lisp
