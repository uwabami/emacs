...
(leaf *gui
  ...
  ;; (set-fontset-font nil '(#x1F004 . #x1FFFD) (font-spec :family "Noto Color Emoji" :height 130))
  (set-fontset-font nil '(#x1F004 . #x1FFFD) (font-spec :family "EAW CONSOLE" :height 130))
)
 #+end_src
 表示のテスト
 #+BEGIN_EXAMPLE
