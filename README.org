...
(leaf org-capture
  ...
  (setq org-capture-templates
        (doct '(("Org-roam journal"
                ...
                ;;  :template "** TODO %(format-time-string org-journal-time-format)%^{title} %^g\n  %?\n  %a"
                ;;  :prepend nil
                ;;  :unnarrowed nil
                ;;  :kill-buffer t
                ;;  )
                ...
                ;;  :type plain
                ;;  :function my:org-journal-add-date-entry-capture
                ;;  :template "** MEMO %(format-time-string org-journal-time-format)%^{title} %^g\n   #+\n   %?"
                ;;  :prepend nil
                ;;  :unnarrowed nil
                ;;  :kill-buffer t
                ;;  )
...
(leaf org-roam
  ...
  (("C-c n a" . org-roam-alias-add)
   ...
   ;; ("C-x M"   . org-roam-dailies-capture-today) ← call from org-capture
   )
  :ensure t
