...
(custom-set-faces
 ...
 '(avy-lead-face                   ((t (:foreground "#020202" :background "#4cff4C" :bold t))))
 '(avy-lead-face-0                 ((t (:foreground "#020202" :background "#ffff4c" :bold t))))
 '(avy-lead-face-1                 ((t (:foreground "#020202" :background "#ff4cff" :bold t))))
 '(avy-lead-face-2                 ((t (:foreground "#020202" :background "#4cffff" :bold t))))
 )
  #+END_SRC
* 日記: =tDiary=
