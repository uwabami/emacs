...
# $Lastupdate: 2012/03/29 04:14:12$
# License: GPL-3+
#
#+TITLE: Emacsの基本設定
...
** 日本語入力
   ...
   [[file:ddskk.org][DDSKKの設定]] で行なっている.
    #+BEGIN_SRC emacs-lisp
      ...
      (setq skk-init-file
            (expand-file-name (concat user-emacs-directory "config/ddskk_config")))
      ;; org-babel-tangle で ddskk.org から ddskk.el を生成
      (my:org-babel-tangle-and-compile-file
       (expand-file-name (concat user-emacs-directory "config/ddskk_config.org")))
...
** emacs-w3m
   #+BEGIN_SRC emacs-lisp
     (when (locate-library "w3m-load")
       (my:org-babel-tangle-and-compile-file
        (expand-file-name
         (concat user-emacs-directory "config/w3m_config.org")))
