...
# $Lastupdate: 2013/01/25 03:54:40$
# License: Expat
#
#+TITLE: Mew の設定
...
* 個人情報
  ...
  #+END_SRC
  パスワードはキャッシュする/master-passwd は使わない.
  #+BEGIN_SRC emacs-lisp
...
* 表示
  ...
  #+BEGIN_SRC emacs-lisp
    ...
    ;;         ))
    ;; (setq mew-header-max-depth 4000)
  #+END_SRC
  メールのソートは日付で行なう
  #+BEGIN_SRC emacs-lisp
...
* 振り分け
  #+BEGIN_SRC emacs-lisp
    (load "~/.mua/refile.gpg")
    (setq mew-refile-guess-alist my:refile-list)
  #+END_SRC
