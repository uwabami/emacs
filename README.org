...
(use-package elscreen
  ...
  (elscreen-start))
  #+END_SRC
  あと [[http://syohex.hatenablog.com/entry/20130914/1379166283][zoom-window]] も使う事に.
  #+BEGIN_SRC emacs-lisp
...
** VCS: =helm-ghq=
   ...
   フルパス表示がちょっとうざったいので、list-candidates を override することに。
   #+BEGIN_SRC emacs-lisp
...
(custom-set-faces
 ...
 ;; '(mode-line                           ((t (:foreground "#F6F3E8" :background "#BF7FFF" ))))
 ...
 ;; powerline
 '(powerline-active1                   ((t (:background "#242424" :foreground "#F6F3E8"))))
