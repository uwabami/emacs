...
(unless (package-installed-p 'package-utils)
  (package-install 'package-utils))
   ...
   batch でインストールできる様に，以下を =tmp/emacs-batch-install.el= として出力します．
   #+BEGIN_SRC emacs-lisp :tangle tmp/emacs-batch-install.el
(unless (file-directory-p (concat user-emacs-directory "packages"))
  (make-directory (concat user-emacs-directory "packages")))
(require 'package)
...
(use-package org-wiki
  :config
  (setq org-wiki-location (concat (getenv "HOME") "/Pulic/cc-env/"))
