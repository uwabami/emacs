...
(leaf modus-themes
  ...
  `(
    ...
    (modus-themes-prompts              . 'intense-accent)
  ...
  (modus-themes-load-vivendi)
   ...
   #+end_src
   #+begin_src emacs-lisp :tangle no
(leaf elemental-theme
  :el-get zk-phi/elemental-theme
  :require t
  :init
  `(add-to-list 'custom-theme-load-path
                ,(expand-file-name "elemental-theme/" my:d:pkg:elget))
  '(custom-set-faces
    '(default
       ((t (:foreground "#eceff1" :background "#263238")))
       )
    ...
    '(elemental-accent-fg-1-face
      ((t (:foreground "#bf7fff" :weight bold))))
    '(elemental-accent-fg-2-face
      ((t (:foreground "#7fbfff" :weight bold))))
    '(elemental-accent-fg-3-face
      ((t (:foreground "#ff7f7f" :weight bold))))
    '(elemental-accent-fg-4-face
      ((t (:foreground "#ffff7f" :weight bold))))
    ;;
    '(elemental-red-fg-face
      ((t (:foreground "#ff7fff" :weight bold))))
    '(elemental-blue-fg-face
      ((t (:foreground "#7f7fff" :weight bold))))
    '(elemental-green-fg-face
      ((t (:foreground "#5CF19E" :weight bold))))
    '(elemental-orange-fg-face
      ((t (:foreground "#ffbf7f" :weight bold))))
    ;;
    '(elemental-red-underline-face
      ((t (:underline (:color "#ff7f7f" :style wave)))))
    '(elemental-yellow-underline-face
      ((t (:underline (:color "#ffff7f" :style wave)))))
    ;;
    '(elemental-ui-prompt
      ((t (:inherit (elemental-accent-fg-1-face bold)))))
    ;;
    '(elemental-ui-component
      ((t (:inherit default :background "#222244"))))
    ...
    '(elemental-file-executable
      ((t (:foreground "#7fff7f" :weight bold))))
    ...
    ;;
    '(tab-bar
      ((t (:inherit elemental-ui-component-diminished ))))
    '(tab-bar-tab
      ((t (:inherit elemental-ui-component :weight bold))))
    '(tab-bar-tab-inactive
      ((t (:inherit elemental-ui-component-transparent))))
    ;;
    '(all-the-icons-red            ((t (:foreground "#ff4c4c"))))
    '(all-the-icons-lred           ((t (:foreground "#ffe1dd"))))
    '(all-the-icons-dred           ((t (:foreground "#6a4c49"))))
    '(all-the-icons-red-alt        ((t (:foreground "#ff4c4c"))))
    '(all-the-icons-green          ((t (:foreground "#4cff4c"))))
    '(all-the-icons-lgreen         ((t (:foreground "#e6ffe0"))))
    '(all-the-icons-dgreen         ((t (:foreground "#50674c"))))
    '(all-the-icons-yellow         ((t (:foreground "#ffff4c"))))
    '(all-the-icons-lyellow        ((t (:foreground "#ffffe1"))))
    '(all-the-icons-dyellow        ((t (:foreground "#68664c"))))
    '(all-the-icons-blue           ((t (:foreground "#4c4cff"))))
    '(all-the-icons-blue-alt       ((t (:foreground "#4c4cff"))))
    '(all-the-icons-lblue          ((t (:foreground "#e5ddff"))))
    '(all-the-icons-dblue          ((t (:foreground "#4f4967"))))
    '(all-the-icons-maroon         ((t (:foreground "#ff4cff"))))
    '(all-the-icons-lmaroon        ((t (:foreground "#ffe3ff"))))
    '(all-the-icons-dmaroon        ((t (:foreground "#684d66"))))
    '(all-the-icons-purple         ((t (:foreground "#bf7fff"))))
    '(all-the-icons-lpurple        ((t (:foreground "#f1e7ff"))))
    '(all-the-icons-dpurple        ((t (:foreground "#595166"))))
    '(all-the-icons-orange         ((t (:foreground "#ffbf7f"))))
    '(all-the-icons-lorange        ((t (:foreground "#ffefe6"))))
    '(all-the-icons-dorange        ((t (:foreground "#675851"))))
    '(all-the-icons-cyan           ((t (:foreground "#4cffff"))))
    '(all-the-icons-cyan-alt       ((t (:foreground "#4cffff"))))
    '(all-the-icons-lcyan          ((t (:foreground "#e6ffff"))))
    '(all-the-icons-dcyan          ((t (:foreground "#506666"))))
    '(all-the-icons-pink           ((t (:foreground "#ff4cff"))))
    '(all-the-icons-lpink          ((t (:foreground "#ffe3ff"))))
    '(all-the-icons-dpink          ((t (:foreground "#684d66"))))
    '(all-the-icons-silver         ((t (:foreground "#a0a0a0"))))
    '(all-the-icons-lsilver        ((t (:foreground "#808080"))))
    '(all-the-icons-dsilver        ((t (:foreground "#ababab"))))
    ;;
    )
  :config
