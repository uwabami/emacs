...
# $Lastupdate: 2012/08/22 14:24:22$
# License: Expat
#
#+TITLE: Emacsの基本設定
...
** [[file:lookup_config.org][lookup-el]]
   ...
   #+END_SRC
** [[file:yasnippet_config.org][yasnippet]]
...
** yaml-mode
   ...
   #+END_SRC
** [[file:rinari_config.org][Rails開発環境(rinari)]]
   #+BEGIN_SRC emacs-lisp
     (my:load-org-file "rinari_config.org")
   #+END_SRC
* Footnotes
...
[fn:8] ELPA: [[http://tromey.com/elpa/install.html]]

[fn:9] Marmalade: [[http://marmalade-repo.org/]]
