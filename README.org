...
** =recentf=: 最近使ったファイル履歴の保管
   ...
   #+begin_src emacs-lisp
(leaf recentf-ext :disabled t :ensure t)
(leaf recentf
...
* チラ見: =quick-preview.el=
  ...
  とはいえ GNOME Sushi 前提なので，GNOME以外の環境だとシンドいかもなぁ...
  #+begin_src emacs-lisp
(leaf quick-preview
  :if (my:dpkg-status "gnome-sushi")
...
(leaf company
  ...
  #+END_SRC
  - [ ] [[https://github.com/TheBB/company-reftex][TheBB/company-reftex]]
  - [ ] [[https://github.com/vspinu/company-math][vspinu/company-math]]
  - [ ] [[https://github.com/alexeyr/company-auctex][alexeyr/company-auctex]]
...
** =moomin=
   ...
   ...とはいえ，結局 =ido= 使わなくなったので，今後はどうするのか決めていなかったり．
   #+BEGIN_SRC emacs-lisp
(leaf moomin
  ...
  (when window-system
    (progn
      ...
      (set-fontset-font nil
                        '(#xE0A0 . #xEEE0)
                        (font-spec :family "FSMRMP" :height 200))
