...
(defun ido-recentf-open ()
  ...
  (interactive)
  (eval-when-compile (require 'recentf nil 'noerror))
...
** plstore
   ...
   #+BEGIN_SRC emacs-lisp
(leaf plstore
  :disabled (not (getenv "GPG_KEY_ID"))
  :init
...
** password-store
   #+BEGIN_SRC emacs-lisp
(leaf password-store
  :disabled (not (and my:d:password-store
...
** Emacs 本体側の設定
   ...
   #+BEGIN_SRC emacs-lisp
(leaf wl
  :disabled (not (and (or (my:dpkg-status "wl")
