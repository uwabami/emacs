...
e.g. \"org3ca6ef0c\"."
  ...
  ;;
  (defmacro my:org-with-point-at (pom &rest body)
...
See https://writequit.org/articles/emacs-org-mode-generate-ids.html"
  ...
  (add-hook 'before-save-hook 'my:add-org-ids-to-headlines-in-file)
  :custom
