...
** TODO [[https://emacs-jp.github.io/packages/package-management/package-el][package.el]] の初期化処理 [0/1]
   :PROPERTIES:
...
(add-hook 'kill-emacs-hook #'my:package-quickstart-refresh-silently)
   #+end_src
   - [ ] 起動時にはここが一番時間がかかっている.
** WAIT [[https://github.com/conao3/leaf.el][leaf.el]] [1/1]
   :PROPERTIES:
...
(leaf eaw-console
  :commands eaw-init
  :vc (:url "git@github.com:uwabami/locale-eaw"
            :branch "custom"
            :make "all"
            :lisp-dir "dist"
            )
  :preface
  (add-to-list 'package-vc-allow-build-commands 'eaw-console)
  (my:vc-installed-package 'eaw-console)
  :init
...
(defun my:setup-gui-frame (&optional frame)
  ...
  (let ((f (or frame (selected-frame))))
    (when (display-graphic-p f)
      ...
      (set-face-attribute 'default nil :family "Victor Mono" :weight 'medium :height 140)
...
(leaf corfu ;; <
  ...
  :preface
  ;; ---------------------------------------------------------------------------
  ;; @see https://github.com/minad/corfu/wiki#advanced-variants-for-separator-handling
;;;###autoload
...
changes to the prompt. Note this function can remove the separator character."
  ...
  :bind (:corfu-map
         ...
         ("C-a"      . nil)
         ("C-e"      . nil)
         ("M-SPC"    . corfu-insert-or-escape-separator)
         )
  ;; -------------------------------------------------------------------------
...
(leaf cape ;; <
  ...
  ((completion-at-point-functions . cape-dabbrev)
   ...
   (completion-at-point-functions . cape-tex)
   )
  :init
