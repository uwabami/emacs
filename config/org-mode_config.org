...
# $Lastupdate: 2012/09/11 12:17:05$
# License: Expat
#
#+TITLE: org-modeの設定
...
* 基本設定
  #+BEGIN_SRC emacs-lisp
    ...
    ;;       '(("t" "Todo" entry (file+headline "~/Documents/Dropbox/org/todo.org" "ToDo")
    ;;          "* TODO %T %?\n  %i\n  %a")
    ;;         ("m" "Memo" entry (file+headline "~/Documents/Dropbox/org/memo.org" "Memo")
    ;;          "* %T %?\n  %i\n  %a")
    ;;         ))
    ...
    ;;       '(("Todo" ?t "TODO %T %?\n   %i\n   %a" "~/Documents/Dropbox/org/todo.howm")
    ;;         ("Memo" ?b "%T %?\n   %i\n   %a" "~/Documents/Dropbox/org/memo.howm")
    ;;         ))
  #+END_SRC
* org-babel
  使う言語の追加
