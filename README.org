...
* はじめに
  ...
  #+html: <amp-img src="https://github.com/uwabami/emacs/workflows/build/badge.svg" width="72px" height="20px" layout=fixed class="travis_badge"></amp-img>
...
(setq leaf--paths nil) ;; workaround https://github.com/conao3/leaf.el/issues/479
(leaf leaf-keywords
  :ensure t
  :init
