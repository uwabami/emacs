...
# $Lastupdate: 2013/01/27 04:19:19$
# License: Expat
#
#+TITLE: org-modeの設定
...
#+END_HTML
* 始めに
  まだ設定が半端なので, そのうちちゃんと書かないと駄目な気がしている.
* 基本設定
...
* org-agenda & mobileorg
  org-ical との連携テスト
  #+BEGIN_SRC emacs-lisp
    (setq org-refile-targes
          (quote (("todo.org" :level 1))))
  ...
  #+BEGIN_SRC emacs-lisp
    ...
    (setq org-agenda-files
          `("~/Dropbox/org/todo.org" "~/Dropbox/org/mobile-pull.org"))
