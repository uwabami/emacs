...
(use-package delight :diminish t)
   #+END_SRC
...
(my:wl-set-face 'wl-highlight-folder-killed-face                  '((t (:foreground "#4c4c4c" :bold nil :italic nil :weight normal ))))
(my:wl-set-face 'wl-highlight-folder-many-face                    '((t (:foreground "#ff7f7f" :bold nil :italic nil :weight normal ))))
...
(my:wl-set-face 'wl-highlight-folder-unread-face                  '((t (:foreground "#4c4cff" :bold nil :italic nil :weight normal ))))
...
(my:wl-set-face 'wl-highlight-message-citation-header             '((t (:foreground "#7fff7f" :bold nil :italic nil ))))
...
(my:wl-set-face 'wl-highlight-summary-deleted-face                '((t (:foreground "#4c4c4c" :bold nil :italic nil :weight normal ))))
...
(my:wl-set-face 'wl-highlight-summary-flagged-face                '((t (:foreground "#ffff7f" :bold nil :italic nil :weight normal ))))
(my:wl-set-face 'wl-highlight-summary-forwarded-face              '((t (:foreground "#7f7fff" :bold nil :italic nil :weight normal ))))
(my:wl-set-face 'wl-highlight-summary-high-read-face              '((t (:foreground "#7fff7f" :bold nil :italic nil :weight normal ))))
(my:wl-set-face 'wl-highlight-summary-high-unread-face            '((t (:foreground "#FFBF7F" :bold nil :italic nil :weight normal ))))
...
(my:wl-set-face 'wl-highlight-summary-killed-face                 '((t (:foreground "#4c4c4c" :bold nil :italic nil :weight normal ))))
(my:wl-set-face 'wl-highlight-summary-l:read-face                 '((t (:foreground "#4CFF4C" :bold nil :italic nil :weight normal ))))
(my:wl-set-face 'wl-highlight-summary-l:unread-face               '((t (:foreground "#666666" :bold nil :italic nil :weight normal ))))
...
(my:wl-set-face 'wl-highlight-summary-prefetch-face               '((t (:foreground "#4c4cff" :bold nil :italic nil :weight normal ))))
(my:wl-set-face 'wl-highlight-summary-refiled-face                '((t (:foreground "#7F7FFF" :bold nil :italic nil :weight normal ))))
(my:wl-set-face 'wl-highlight-summary-resend-face                 '((t (:foreground "#FFBF7F" :bold nil :italic nil :weight normal ))))
(my:wl-set-face 'wl-highlight-summary-target-face                 '((t (:foreground "#4CFFFF" :bold nil :italic nil :weight normal ))))
(my:wl-set-face 'wl-highlight-summary-temp-face                   '((t (:foreground "#BF7FFF" :bold nil :italic nil :weight normal ))))
...
(use-package ido-ghq
  ...
  (setq ido-ghq-short-list t)
   ...
   #+END_SRC
* Project管理: =projectile=
  沢山 project がある環境だとツライ気がする...
  #+BEGIN_SRC emacs-lisp
(use-package projectile
  ...
  (setq projectile-project-search-path nil
        ...
        (expand-file-name "projectile-bookmarks.eld" my:d:share)
        projectile-enable-caching t
        projectile-find-dir-innclude-top-level t
        )
  (advice-add 'projectile-switch-project :around #'my:ido-grid-force-one-columns)
  (projectile-mode +1)
  )
  #+END_SRC
                  ...
                  '("%e"
                    (:eval
                     (let* ((active (powerline-selected-window-active))
                            ...
                            (lhs (list (powerline-raw (substring skk-modeline-input-mode 2 -1) nil 'l)
...
(delight '((emacs-lisp-mode       "" :major)
           ...
           (wl-folder-mode        "" :major)
           (wl-summary-mode       "" :major)
           (wl-draft-mode         "" :major)
           (mime-view-mode        "" :major)
           (isearch-mode          nil)
           (devlock-mode          nil)
           ))
   #+END_SRC
