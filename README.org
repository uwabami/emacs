...
* 補完: =ido=
  ...
  find-file は helm-find-file より ido + flx-ido + ido-grid の方が好みなんだが,
  どうしようかなぁ...
** =ido= の設定
   #+BEGIN_SRC emacs-lisp
(use-package ido
  ...
  :config
  (ido-mode -1)
  (ido-everywhere nil)  ; <- 過去の選択を覚えている奴と相性悪いので無効化
...
(custom-set-faces
 ...
 '(ido-grid-common-match ((t (:background "#4c4c4c"))))
