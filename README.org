...
*** 起動後に GC Threshold を既定値に戻す
    ...
    :END:
    +以前は以下を設定していたが, 最近は =gcmh= に任せる事にした.+
    → [[id:cca3e8df-79f9-4c60-a803-07ff641b0ef7][=gcmh=: 賢い garbage-collection]]
...
(leaf org-wiki
  ...
  :init
  ;; (my:vc-installed-package 'org-wiki)
