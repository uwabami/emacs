...
** rail
   ...
   #+BEGIN_SRC emacs-lisp
     (unless (locate-library "rail")
       (bundle rail :type gthub :pkgname "uwabami/rail"))
...
** (あれば) elscreen-wl を使う
   #+BEGIN_SRC emacs-lisp
     (when (locate-library "elscreen-wl")
...
** google-contacts-wl
   ...
   #+BEGIN_SRC emacs-lisp
     (bundle! google-contacts-wl :type github :pkgname "uwabami/google-contacts-wl")
   #+END_SRC
** offlineimap-el
   #+BEGIN_SRC emacs-lisp
     (bundle! offlineimap)
...
* mhc
  ...
  #+BEGIN_SRC emacs-lisp
    ...
    ;; (setq mhc-mail-path
    ;;       (expand-file-name (concat (getenv "HOME") "/Mail")))
