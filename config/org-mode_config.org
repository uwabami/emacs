...
# $Lastupdate: 2013/02/02 06:24:14$
# License: Expat
#
#+TITLE: org-modeの設定
...
** キーバインド
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (define-key global-map (kbd "C-c a") 'howm-menu)
   #+END_SRC
** auto-mode-alist
...
** ディレクトリの設定
   #+BEGIN_SRC emacs-lisp
     (setq org-mobile-directory
           (concat  my:dropbox "MobileOrg"))
     (setq my:mobile-sync-files
           `("~/Dropbox/org/schedule.org"
             "~/Dropbox/org/todo.org"
             ))
     (setq org-mobile-files my:mobile-sync-files)
     (setq org-mobile-inbox-for-pull
           (concat org-directory "mobile-pull.org"))
     (setq org-mobile-creating-agendas t)
