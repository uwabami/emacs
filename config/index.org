...
# $Lastupdate: 2013/01/27 23:40:48$
# License: Expat
#
...
---
layout: emacs
title: Emacsの基本設定 - 主に org ファイルの読み込み集
---
#+END_HTML
* 始めに
...
** install
   ...
   CVSを使っている(= 本家 CVS は proxy を越えられない)ので
   ...
   #+BEGIN_EXAMPLE
   (:name ddskk
       :description "Github mirror for Daredevil SKK"
       :type github
...
* [[file:lookup_config.org][lookup-el]]
  ...
  #+END_SRC
* メモ環境
  個々の設定はそれぞれ [[file:org-mode_config.org][org-modeの設定]], [[file:howm_config.org][howm の設定]], [[file:calfw_config.org][calfw: カレンダーの設定]] を参照の事.
  ...
  #+BEGIN_SRC emacs-lisp
    (if my:check-dropbox
        (progn
          ...
          (my:load-org-file "calfw_config.org")
          )
      )
  #+END_SRC
