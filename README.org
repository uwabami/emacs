...
** Org-Wiki
    計算機関連のメモは [[https://github.com/uwabami/plain-org-wiki][uwabami/plain-org-wiki]] で書いています．
    #+BEGIN_SRC emacs-lisp
...
(use-package plain-org-wiki
  ...
  (defun plain-org-wiki-insert-header ()
...
(use-package projectile
  :config
  (setq projectile-cache-file (concat my:d:tmp "projectile.cache")
        projectile-known-projects-file (concat my:d:tmp "projectile-bookmarks.eld")
        projectile-completion-system 'ido
        projectile-mode-line
        '(:eval (unless (string-match "-" (projectile-project-name))
