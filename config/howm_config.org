...
# $Lastupdate: 2013/02/04 21:47:22$
# License: Expat
#
#+TITLE: howm の設定
...
* ディレクトリの設定
  ...
  #+BEGIN_SRC emacs-lisp
    (setq howm-directory (concat my:dropbox "org"))
    ;; メニューと履歴を検索対象から除外するために別ディレクトリへ
    (setq howm-keyword-file (concat my:dropbox ".howm/keys"))
    (setq howm-history-file (concat my:dropbox ".howm/history"))
    (setq howm-menu-file (concat my:dropbox ".howm/menu"))
...
** 検索対象除外ファイル
   ...
   #+BEGIN_SRC emacs-lisp
     (setq howm-excluded-file-regexp
           "/\\.#\\|[~#]$\\|\\.bak$\\|/CVS/\\|\\.doc\\|\\.pdf\\|\\.txt$\\|\\.html$\\|\\.tex$\\|\\.dvi$\\|\\.fdb_latexmk$\\|\\.ppt$\\|\\.xls$\\|\\.howm-menu$\\|.howm-keys$\\|\\.png$\\|\\.gif$\\|\\.tif$\\|\\.tiff$\\|\\.jpg$\\|\\.jpeg$\\|\\.el$\\|\\.aux$\\|\\.log$\\|Makefile\\|\\.txt$\\|EUC-UCS2\\|\\.fdb_latexmk$\\|latexmkrc")
   #+END_SRC
** org-mode 連携用
    #+BEGIN_SRC emacs-lisp
      ;; 日付検索用の regexp
