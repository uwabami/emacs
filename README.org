...
;; ---------------------------------------------------------------------------
;;;###autoload
(defun my:register-vc-installed-package (pkgname)
...
(leaf eaw-halfwidth
  :commands eaw-init
  :vc (:url "https://github.com/uwabami/locale-eaw"
            :make "all"
            :lisp-dir "dist"
            )
  :preface
  (add-to-list 'package-vc-allow-build-commands 'eaw-halfwidth)
  :init
  (my:register-vc-installed-package 'eaw-halfwidth)
...
;;;###autoload
  ...
  ;;                         "Moto Color Emoji-Moralerspace Argon" 1
  ;;                         ))
  ;; ;;;###autoload
  ;;   (defun my:apply-font-PlemolJP-Console ()
  ;;     (interactive)
  ;;     (my:setup-gui-fonts "PlemolJP Console NF" 135
  ;;                         "PlemolJP Console NF" 1.0
  ;;                         ;; "Moto Color Emoji for PlemolJP" 1.0
  ;;                         "EAW CONSOLE" 1.0
  ;;                          ))
;; ;;;###autoload
;;   (defun my:apply-font-Cica ()
;;     (interactive)
;;     (my:setup-gui-fonts "PlemolJP Console NF" 135
;;                         "PlemolJP Console NF" 1.0
;;                         "Cica" 1.0
...
(leaf consult-ghq
  ...
  :init
  (my:register-vc-installed-package 'consult-ghq)
...
(leaf corfu
  ...
  :bind (:corfu-map
         ...
         ("RET"        . corfu-magic-insert-or-next-line)
         ("delete"     . corfu-magic-insert-or-next-line)
         ("backspace"  . corfu-magic-insert-or-next-line)
         )
  ;; -------------------------------------------------------------------------
  :hook (emacs-startup-hook . (lambda ()
...
** =cape=: Completion At Point Extensions … 補完 backend
   ...
   ただ, 補完されるワードに装飾が付いてたりするので, ちょっと利用は保留
   #+begin_src emacs-lisp :tangle init.el
(leaf cape
  :disabled t
  :emacs>= 29.1  ;; <
...
;;;###autoload
  ...
  ;; -------------------------------------------------------------------------
  :init
  (my:register-vc-installed-package 'f90-ts-mode)
  (leaf f90
    :config
...
(leaf git-commit-ts-mode
  ...
  :mode "\\COMMIT_EDITMSG\\'"
  :init
  (my:register-vc-installed-package 'git-commit-ts-mode)
  )
   #+end_src
* 翻訳
  :PROPERTIES:
...
(leaf text-adjust
  ...
  :init
  (my:register-vc-installed-package 'text-adjust)
  )
   #+end_src
...
(leaf *orgmine
  ...
  (leaf orgmine
    ...
    :init
    (my:register-vc-installed-package 'orgmine)
...
(leaf org-wiki
  ...
  :init
  (my:register-vc-installed-package 'org-wiki)
...
(leaf ox-jekyll
  ...
  :init
  (my:register-vc-installed-package 'ox-jekyll)
  )
(leaf ox-html
  :after ox
  :init
...
(leaf tdiary-mode
  ...
  :init
  (my:register-vc-installed-package 'tdiary-mode)
  :config
