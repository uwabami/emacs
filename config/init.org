...
# $Lastupdate: 2012/08/08 16:17:10$
# License: Expat
#
#+TITLE: Emacsの基本設定
...
*** 行末の無駄な空白/改行を削除する
    ...
    RD や Markdown だと空白行に意味があったりするので, 拡張子で判断して外している.
    #+BEGIN_SRC emacs-lisp
      (defvar my:delete-trailing-whitespace-exclude-suffix
            (list "\\.rd$" "\\.md$" "\\.rbt$"))
      (defun my:delete-trailing-whitespace ()
        (interactive)
        (cond ((equal nil (loop for pattern in my:delete-trailing-whitespace-exclude-suffix
...
** TODO EasyPG[0/1]
   ...
   #+END_SRC
* 外部emacs-lispなどの設定/分割した設定ファイルの読み込み
...
** [[file:auto-install_config.org][auto-installとinstallしたelispの設定]]
   ...
   #+END_SRC
** [[http://tromey.com/elpa/install.html][ELPA]] [fn:8]
...
*** install
    ...
    適宜修正しておくこと
*** 設定
    リポジトリとして [[http://marmalade-repo.org/][Marmalade]] [fn:9]も追加しておく
    #+BEGIN_SRC emacs-lisp
...
** MUA
   ...
   #+BEGIN_SRC emacs-lisp
     (cond
      ((string-match system-name "daphne.localdomain")
