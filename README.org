...
*** フォント設定
   ...
   以下, [[https://qiita.com/jado4810/items/5dd9f1b41ea5d1a4ec74][Unicode時代のCJKT環境におけるEmacsのフォント設定 #Emacs - Qiita]] を参照のこと.
 #+begin_src emacs-lisp :tangle init.el
(leaf *gui
  :if window-system
  :preface
...
;;;###autoload
  (defun my:setup-fontset ()
    ...
    ;; (set-face-font 'default "Victor Mono-14")
    ...
    (dolist (target '(katakana-jisx0201
      ...
      (set-fontset-font nil target (font-spec :family "Migu 1M") nil t))
    (dolist (target '(unicode
                      latin-iso8859-1
                      latin-iso8859-2
                      latin-iso8859-3
                      latin-iso8859-4
                      ...
                      greek-iso8859-7
                      hebrew-iso8859-8))
      (set-fontset-font nil target (font-spec :family "Victor Mono") nil t))
    (when (boundp 'code-half)
      (dolist (target code-half)
        (set-fontset-font nil target (font-spec :family "Victor Mono") nil t)
        ))
    (when (boundp 'code-wide)
...
;;;###autoload
  ...
  ((window-setup-hook . (lambda ()
   ...
   (after-make-frame-functions . (lambda ()
                                   (my:setup-fontset)
                                   (my:setup-gui-frame)
                                   ))
   )
...
;;;###autoload
  ...
  :init
  (setopt xref-show-xref-funcion          #'consult-xref
...
(leaf orgmine
  ...
  :config
  (setopt orgmine-note-block-begin "#+begin_src gfm"   ;; 要調整
