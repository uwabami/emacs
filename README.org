...
(leaf leaf-keywords
  ...
  (leaf-keywords-init)
   ...
   #+end_src
* [[https://gitlab.com/koral/gcmh][Koral/gcmh]]: Garbage Collector Magic Hack
  :PROPERTIES:
  :CUSTOM_ID: org3133d7dd
  :END:
  とりあえず試してみることに
  #+BEGIN_SRC emacs-lisp :tangle int.el
(leaf gcmh
  :ensure t
  :blackout t
  :config
