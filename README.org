...
** =setopt= の導入
   :PROPERTIES:
   :CUSTOM_ID: orgc9962cbc
   :END:
   Emacs ≧ 29.1 から使える =setopt= を
   古い Emacs のために移植しておくことに.
   #+begin_src emacs-lisp :tangle (if (version<= emacs-version "29.1") "init.el" "no") ;>
;; ---------------------------------------------------------------------------
;; From Emacs 30.1
;; ---------------------------------------------------------------------------
;;;###autoload
...
(setq gc-cons-threshold most-positive-fixnum
    ...
    #+end_src
    [[#org0bd0c625][=esup=]] がまだ =early-init.el= を読まないので,
...
(add-hook 'emacs-startup-hook
    ...
    #+end_src
    - [ ] gcmh は無駄にタイマーを増やし過ぎて, 結果, 自分が増やしたタイマーで GC を走らせる, という指摘もある.
** Package初期化処理
   :PROPERTIES:
...
** TODO [[https://emacs-jp.github.io/packages/package-management/package-el][package.el]] の初期化処理 [/]
   :PROPERTIES:
   :CUSTOM_ID: org61dc7202
   :END:
   #+begin_src emacs-lisp :tangle init.el
;; esup が early-init を呼ばない...
(setq package-quickstart-file "~/.cache/emacs/package-quickstart.el"
      package-quickstart t)
;;;###autoload
...
** =cape=: Completion At Point Extensions … 補完 backend
   ...
   [[https://github.com/minad/cape/blob/main/README.org][README]] によれば
