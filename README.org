...
(leaf flymake
  ...
  :custom
  ((flymake-allowed-file-name-masks . '(("\\.\\(?:c\\(?:pp\\|xx\\|\\+\\+\\)?\\|CC\\)\\'" flymake-proc-simple-make-init nil flymake-proc-real-file-name-considering-includes)
                                        ...
                                        ("\\.\\(f\\|F\\)\\(9\\|0\\)?\\(0\\|3\\)?\\'" flymake-proc-simple-make-init))
                                    ))
  )
  #+END_SRC
  - [ ] 設定調整が必要
