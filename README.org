...
(leaf *doom-modeline-settings
  :diminish (;; minor-mode settings
             (isearch-mode (all-the-icons-faicon "search"))
             (org-src-mode (all-the-icons-octicon "code"))
             )
  :init
  (leaf doom-modeline
    :ensure t
...
mouse-1: Display Line and Column Mode Menu"
            ...
            (ignore-errors
              (cond (buffer-read-only
                     (doom-modeline-buffer-file-state-icon
                      "lock"
                      (all-the-icons-material "lock") ;; "%1*"
                      'doom-modeline-warning))
                    ((and buffer-file-name (buffer-modified-p)
                          doom-modeline-buffer-modification-icon)
                     (doom-modeline-buffer-file-state-icon
                      "save"
                      (all-the-icons-material "save")  ;;"%1*"
    ...
    (doom-modeline-def-modeline 'main
      '(;; bar
        input-method-skk my:buffer-encoding remote-host buffer-info
                         ;; matches
                         ;; parrot
                         ;; selection-info
                         )
