  ...
  (eval-when-compile
    (make-translation-table
     (nconc 
      ...
      (make-jisx0208-to-0213-translation-pair ?$(O-~(B)
      (make-jisx0208-to-0213-translation-pair ?$(O.!(B) ;; [2004]
      (make-jisx0208-to-0213-translation-pairs ?$(O."(B ?$(O/}(B)
      (make-jisx0208-to-0213-translation-pair ?$(O/~(B) ;; [2004]
      ...
      (make-jisx0208-to-0213-translation-pair ?$(OO:(B)
      (make-jisx0208-to-0213-translation-pair ?$(OO?(B)
      (make-jisx0208-to-0213-translation-pair ?$(OOT(B) ;; [2004]
      (make-jisx0208-to-0213-translation-pairs ?$(OOU(B ?$(OO}(B)
      (make-jisx0208-to-0213-translation-pair ?$(OO~(B) ;; [2004]
      ...
      (make-jisx0208-to-0213-translation-pair ?$(Ot'(B) ;; [2004]
      (make-jisx0208-to-0213-translation-pairs ?$(Ot((B ?$(O~y(B)
      (make-jisx0208-to-0213-translation-pairs ?$(O~z(B ?$(O~~(B) ;; [2004]
      ))))
